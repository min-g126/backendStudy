...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* API란?
         * Application Programming Interface는 응용프로그램에서 사용할 수 있또록,
         * 운영체제나 프로그래밍 언어가 제공하는 기술을 제어할 수 있도록 만든 인터페이스를 뜻한다.
        ...
        /* 1-2. import를 해서 사용 */
        /* 클래스의 full-name 말고 클래스명만 작성하려면 import를 배워야 한다고 배웠다.
