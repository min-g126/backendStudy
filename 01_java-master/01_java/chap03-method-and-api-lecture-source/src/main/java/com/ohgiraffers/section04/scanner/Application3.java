...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* "안녕하세요. 반갑습니다" 입력시 공백을 기준으로 두 개의 토큰 "안녕하세요"와 "반갑습니다"로 분리가 됩니다.
         * next()는 다음 토큰인 "안녕하세요"를 읽었고, nextInt()는 다음 토큰을 정수로 읽어야 하는데 "반갑습니다"가 나왔습니다.
         * 정수를 입력해야 할대, "반갑습니다"를 읽으면 InputMismatchException이 발생하게 된다.
         * 공백이 있는 문자열을 받을거면 nextLine()을 이용해야 한다.
         * */

        /* 혹은 입력받은 버퍼를 줄 단위 토큰으로 분리하기 때문에 해당 라인의 토큰을 다 읽고 다음 줄로 이동시키고
         * 싶을 때는 한 라인의 모든 토큰을 읽어오는 sc.nextLine(); 호출을 중간에 한 번 넣어줘도 해결은 된다.
         * */
        ...
        * 그 행을 읽어들이는걸 다음 행으로 넘기게 되고, 그 이후 새로 입력받은 한 라인을 읽어와서 str2에 저장하게
        * 되므로 정상 동작하게 된다.*/
    }
