...
public class User {
     ...
     * 3. 작성한 생성자 외에는 인스턴스를 생서앟는 방법을 제공하지 않는다는 의미를 가진다.
     *    따라서, 인스턴스를 생성하는 방법ㅇ르 제한하기 위한 용도로 사용할 수도 있다. (초기값 전달 강제화)
     * */
     ...
     * 1. 기본생성자(매개변수 없는 생성자)
     * 2. 매개변수 있는 생성자
     * 기본생성자는 자바 Commpiler가 자동으로 추가해주는 구문이지만 명시적으로 작성할 수도 있다.
...
//        this.enrollDate = enrollDate;
        ...
        *  괄호 안에 매개변수의 타입, 갯수, 순서에 마즌 생성자를 호출하고 복귀한다. (메소드와 동일함)
